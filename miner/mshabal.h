...
void simd128_sse2_mshabal_openclose_fast(mshabal_context_fast* sc, void* u1, void* u2, void* dst0,
                                    void* dst1, void* dst2, void* dst3, unsigned n);


typedef struct  {
	char Path[96]; 
	char Name[96]; //20_20_20_20
...
extern void send_report(unsigned long long accid, unsigned long long height, unsigned long long nonce, unsigned long long dl);
...
void procscoop_sse_fast(hash_arg_t *parg);
void procscoop_avx_fast(hash_arg_t *parg);
